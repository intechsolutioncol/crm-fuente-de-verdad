...
-- ================================================================
-- MINISTERIOS — blogs públicos por ministerio. Configurables desde
-- Configuración, líder asignado desde ahí también.
-- ================================================================
...
-- No sensible: cualquier miembro autenticado puede ver la lista. La
-- lectura pública del blog bypasea RLS vía el cliente admin.
...
-- ¿El usuario actual puede gestionar ESTE ministerio? (es su líder,
-- o es Administrador). Se reutiliza en publicaciones_ministerio y Storage.
...
-- La ruta de cada archivo empieza con "<ministerio_id>/...".
