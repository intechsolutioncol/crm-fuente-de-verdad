...
interface SidebarProps {
  ...
  userInitial: string
  userEmail: string
  userRol?: RolMiembro | null
  onClose?: () => void
}

export function Sidebar({ userName, userInitial, userEmail, userRol, onClose }: SidebarProps) {
  ...
  const activeItems = userRol === 'Administrador'
    ? [...ACTIVE_ITEMS, REPORTES_ITEM, CONFIGURACION_ITEM]
    : ACTIVE_ITEMS
